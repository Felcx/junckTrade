...
public class AdminDAO {
	...
	public Admin findById(java.lang.Integer id) {
		...
		try {
			Admin instance = (Admin) getCurrentSession().get("com.lichao.bean.Admin", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.lichao.bean.Admin").add(Example.create(instance))
					.list();
