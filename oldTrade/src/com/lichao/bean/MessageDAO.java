...
public class MessageDAO {
	...
	public List findByExample(Message instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.lichao.bean.Message").add(Example.create(instance))
					.list();
	...
	public List findByIsHistory(Object isHistory) {
		return findByProperty(IS_HISTORY, isHistory);
	}
	...
	public Message merge(Message detachedInstance) {
		...
		try {
			Message result = (Message) getCurrentSession().merge(detachedInstance);
