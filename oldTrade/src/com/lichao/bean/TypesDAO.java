...
public class TypesDAO {
	...
	public Types findById(java.lang.Integer id) {
		...
		try {
			Types instance = (Types) getCurrentSession().get("com.lichao.bean.Types", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Types instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("com.lichao.bean.Types").add(Example.create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Types instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Types as model where model." + propertyName + "= ?";
	...
	public List findByIsShowFirst(Object isShowFirst) {
		return findByProperty(IS_SHOW_FIRST, isShowFirst);
	}
	...
	public Types merge(Types detachedInstance) {
		...
		try {
			Types result = (Types) getCurrentSession().merge(detachedInstance);
